var Gantt = (function() {
    ...
    class Bar {
      ...
      prepare_values() {
        ...
        this.duration = date_utils.diff(this.task._end, this.task._start, 'second')/ 3600; //60 minutes in an hour
        if(this.duration < 0.0002){
          this.duration = 0.01;
        }
    ...
    class Gantt {
      ...
      get_date_info(date, last_date, i) {
        ...
        const date_text = {
          ...
          'Hour_upper': date.getDay() !== last_date.getDay() || date.getMonth() !== last_date.getMonth() || date.getFullYear() !== last_date.getFullYear() ? date_utils.format(date, 'D MMM', this.options.language) : "",
      ...
      view_is(modes) {
        ...
        if (typeof modes === 'string') {
          return this.options.view_mode.toUpperCase() === modes.toUpperCase();
        }
  
        if (Array.isArray(modes)) {
          return modes.some(mode => this.options.view_mode.toUpperCase() === mode.toUpperCase());
        }
